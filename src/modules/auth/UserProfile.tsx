  ...
  return (
    <div className={classNames('flex flex-col gap-10 text-secondary-content', styles?.container)}>
      ...
      <div className="flex flex-row gap-6">
        <Button style="secondary" className="my-auto" copy="Log out" onClick={handleLogOutButtonClick} />
        <Button style="ghost" className="my-auto text-red-500" copy="Delete Profile" onClick={handleOpenModalClick} />
        <div className="grow mx-auto">
          <span className={classNames('loading loading-spinner loading-lg', { hidden: !isLoading })}></span>
        </div>
        {Boolean(error) && <p className="font-bold text-red-500 text-xl mb-6">error</p>}
      </div>
      ...
      >
        ...
        <form method="dialog" className="modal-box p-8 max-w-lg" onClick={e => e.stopPropagation()}>
          <div>
            <p className="font-bold text-xl mb-6">Are you sure you want to delete the user profile?</p>
            <div className="flex flex-row gap-4 justify-center">
              <Button style="primary" className="my-auto" copy="Cancel" onClick={handleCloseModalClick} />
              <Button
                style="ghost"
