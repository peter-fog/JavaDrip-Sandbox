  ...
  return (
    <>
      <div className="dropdown">
        ...
        >
          {!isLoading ? (
            <p className="font-normal uppercase mb-2 mt-2 text-center">Hello, {profile?.name || 'stranger'}</p>
          ) : (
            <p className="font-normal uppercase mb-2 mt-2 text-center">Loading...</p>
          )}
