...
const AlgoliaRefinementList: FC<ComponentProps<Props>> = ({ refinementListParams, component }) => {
  ...
  return (
    <div className="w-full flex justify-center">
      <div className="pt-12 lg:pr-10 inline-flex flex-col w-full first:pt-2 min-h-[250px]">
        ...
        <RefinementList
          ...
          classNames={{
            item: 'mt-4 pl-2 hover:opacity-30 text-secondary-content',
            checkbox: 'hidden',
            selectedItem:
            ...
            label: 'cursor-pointer flex justify-between items-center w-full',
